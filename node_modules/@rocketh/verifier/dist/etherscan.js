...
export async function submitSourcesToEtherscan(env, config) {
    ...
    async function submit(name) {
        ...
        const abiResponse = await fetch(`${endpoint}?chainid=${env.chainId}&module=contract&action=getabi&address=${address}&apikey=${etherscanApiKey}`);
        ...
        async function checkStatus() {
            ...
            const statusResponse = await fetch(`${endpoint}?chainid=${env.chainId}&apikey=${etherscanApiKey}&guid=${guid}&module=contract&action=checkverifystatus`);
