 ...
 */
export function buildAssert(chai, negated, ssfi) {
    return function ({ condition, messageFalse, messageTrue, solidityStack, }) {
        if (!negated && !condition) {
            ...
            throw new chai.AssertionError(message, { __solidityStack: solidityStack }, ssfi);
        }
        if (negated && condition) {
