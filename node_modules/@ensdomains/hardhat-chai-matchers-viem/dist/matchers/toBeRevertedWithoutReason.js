...
const toBeRevertedWithoutReasonMessage = ({ negated, why, }) => {
    return [
        "",
        matcherHint({
...
export function supportRevertedWithoutReason(chai) {
    addMethod(chai, TO_BE_REVERTED_WITHOUT_REASON_MATCHER, async function () {
...
//# sourceMappingURL=toBeRevertedWithoutReason.js.map