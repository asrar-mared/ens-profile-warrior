...
const base32Nano = utils.chain(radixNano, utils.alphabet("13456789abcdefghijkmnopqrstuwxyz"), utils.join(""));
export const encodeNanoAddress = (source) => {
...
export const decodeNanoAddress = (source) => {
