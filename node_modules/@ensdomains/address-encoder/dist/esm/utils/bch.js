...
const bchBase32 = utils.chain(utils.alphabet("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), utils.join(""));
...
export const encodeBchAddressWithVersion = (version, source) => {
...
export const decodeBchAddressToTypeAndHash = (source) => {
