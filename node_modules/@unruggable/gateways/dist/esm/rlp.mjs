...
export function encodeRlpUint(x) {
...
export function encodeRlpOptionalList(v) {
    return encodeRlp(v.slice(0, 1 + v.findLastIndex((x) => x)).map((x) => x || '0x'));
}
export function encodeRlpBlock(block) {
