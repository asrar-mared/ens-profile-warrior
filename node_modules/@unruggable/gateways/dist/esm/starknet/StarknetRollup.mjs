...
import { StarknetProver } from './StarknetProver.mjs';
...
const SLOT_STATE_ROOT = BigInt(keccakStr('STARKNET_1.0_INIT_STARKNET_STATE_STRUCT'));
export class StarknetRollup extends AbstractRollup {
    ...
    encodeWitness(commit, proofSeq) {
        return ABI_CODER.encode(['(uint256, bytes, bytes, bytes, bytes[], bytes)'], [
            commit.index,
