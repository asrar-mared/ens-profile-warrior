...
export function isInclusionProof(proof) {
...
export const EMPTY_STORAGE_HASH = '0x07977874126658098c066972282d4c85f230520af3847e297fe7524f976873e5';
export function isContract(accountProof, requireStorage = false) {
    return (isInclusionProof(accountProof) &&
...
export function encodeProof(proof) {
    ...
    return ABI_CODER.encode([T, T], isInclusionProof(proof)
        ? [
