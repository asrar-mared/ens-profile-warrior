...
import { withResolvers, toPaddedHex, isRPCError, fetchStorage, } from '../utils.mjs';
import { isInclusionProof, isContract, encodeProof, EMPTY_STORAGE_HASH, } from './types.mjs';
...
export class LineaProver extends BlockProver {
    ...
    static isInclusionProof = isInclusionProof;
    ...
    async _proveNeed(need, accountRef, slotRefs) {
        ...
        if (isContract(proofs.accountProof, true)) {
            m.forEach(([, ref], i) => (ref.proof = encodeProof(proofs.storageProofs[i])));
        }
    }
