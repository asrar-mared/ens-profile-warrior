...
export class NitroRollup extends AbstractArbitrumRollup {
    ...
    async _fetchCommit(index) {
        ...
        const encodedRollupProof = ABI_CODER.encode(['(uint64, bytes32, bytes)'], [[index, sendRoot, encodeRlpBlock(block)]]);
