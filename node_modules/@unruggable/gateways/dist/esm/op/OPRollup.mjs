import { AbstractOPRollup } from './AbstractOPRollup.mjs';
...
export class OPRollup extends AbstractOPRollup {
    ...
    constructor(providers, config, minAgeSec = 0) {
        ...
        this.OutputFinder = new Contract(config.OutputFinder, FINDER_ABI, this.provider1);
    }
    get unfinalized() {
    ...
    async fetchOutput(index) {
        try {
            ...
            if (isCallException(err) && err.revert?.name === 'OutputNotFound')
                return;
            throw err;
        }
    }
