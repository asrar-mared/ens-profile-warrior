...
import { isEthersError } from '../utils.mjs';
import { AbstractOPRollup, hashOutputRootProof, } from './AbstractOPRollup.mjs';
...
export class OPFaultRollup extends AbstractOPRollup {
    ...
    constructor(providers, config, minAgeSec = 0) {
        ...
        this.OptimismPortal = new Contract(config.OptimismPortal, PORTAL_ABI, this.provider1);
        this.GameFinder = new Contract(config.GameFinder, FINDER_ABI, this.provider1);
    }
    get unfinalized() {
