...
exports.encodeRlpUint = encodeRlpUint;
exports.encodeRlpOptionalList = encodeRlpOptionalList;
exports.encodeRlpBlock = encodeRlpBlock;
...
function encodeRlpOptionalList(v) {
    return (0, utils_1.encodeRlp)(v.slice(0, 1 + v.findLastIndex((x) => x)).map((x) => x || '0x'));
}
