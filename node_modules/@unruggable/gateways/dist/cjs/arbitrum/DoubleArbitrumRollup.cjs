...
exports.DoubleArbitrumRollup = void 0;
const rollup_js_1 = require("../rollup.cjs");
const NitroRollup_js_1 = require("./NitroRollup.cjs");
...
function createRequestForNitro(address, unfinalized = false) {
    ...
    const req = new vm_js_1.GatewayRequest(2); // 3
...
class DoubleArbitrumRollup extends rollup_js_1.AbstractRollup {
    rollup12;
    rollup23;
    request;
    constructor(rollup12, provider3, config23, minAgeBlocks23 = 0) {
        ...
        this.rollup23 = new NitroRollup_js_1.NitroRollup({ provider1: rollup12.provider2, provider2: provider3 }, config23, minAgeBlocks23);
    ...
    encodeWitness(commit, proofSeq23) {
        return utils_js_1.ABI_CODER.encode(['(bytes,bytes[],bytes)[2]'], [
            [
                [
...
exports.DoubleArbitrumRollup = DoubleArbitrumRollup;
