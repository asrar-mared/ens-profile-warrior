...
class OPRollup extends AbstractOPRollup_js_1.AbstractOPRollup {
    ...
    static FINDERS = new Map([
        ...
        [chains_js_1.CHAINS.OP_BNB, FINDER_OP_BNB],
    ]);
    ...
    constructor(providers, config, minAgeSec = 0) {
        ...
        this.OutputFinder = new contract_1.Contract(config.OutputFinder, FINDER_ABI, this.provider1);
    }
    get unfinalized() {
    ...
    async fetchOutput(index) {
        try {
            ...
            if ((0, ethers_1.isCallException)(err) && err.revert?.name === 'OutputNotFound')
                return;
            throw err;
        }
    }
