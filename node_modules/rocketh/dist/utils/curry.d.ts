 ...
 * It also supports getter properties that can be accessed directly.
 *
 ...
 * };
 *
 * const curried = withEnvironment(env, functionsAndGetters);
 *
 * // Now you can call functions without passing env:
 * await curried.deploy('MyContract', []);
 * await curried.verify('0x123...');
 *
 * // And access getter properties directly:
 * console.log(curried.myValue);
 * console.log(curried.networkId);
 * ```
 */
