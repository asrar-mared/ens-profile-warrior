...
import { DeterministicDeploymentInfo, type Create2DeterministicDeploymentInfo, type Create3DeterministicDeploymentInfo } from '../executor/index.js';
...
export type Config<AccountsType extends UnresolvedUnknownNamedAccounts = UnresolvedUnknownNamedAccounts, Data extends UnresolvedNetworkSpecificData = UnresolvedNetworkSpecificData> = {
...
export type ResolvedConfig<AccountsType extends UnresolvedUnknownNamedAccounts = UnresolvedUnknownNamedAccounts, Data extends UnresolvedNetworkSpecificData = UnresolvedNetworkSpecificData> = Config & {
    deployments: string;
    scripts: string[];
    tags: string[];
    network: {
